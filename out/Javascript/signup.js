...
const firebaseConfig = {
  ...
  function register () {
    ...
    dob = document.getElementById('DOB').value //try to figure out date of birth later
    ...
    if(month.length == 1){ //for months 1-9 we need the 0 to make it like 09
      month = "0" + month;
    }
  ...
  function validate_field(field) { //check field lengths
    if (field == null) {
      return false
    }
